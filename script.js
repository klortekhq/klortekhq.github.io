const translations = {
  en: {
    ...
    felikaTitle: "Send it. Verify it.<br />Forget it.",
    felikaCopy: "A privacy-first open-source file transfer app built around explicit pairing, ephemeral sessions and direct encrypted peer-to-peer delivery.",
    felikaTags: "P2P · Privacy · Cross-platform · Open source",
    arelisTitle: "Messages<br />find a way.",
    arelisCopy: "A privacy-first distributed messenger that keeps messages moving across direct links, local peers and opportunistic store-and-forward routes.",
    arelisTags: "Messaging · Mesh · DTN · Open source",
  ...
  es: {
    ...
    thingsOut: "Lo que estamos construyendo.",
    ...
    felikaTitle: "Envíalo. Verifícalo.<br />Olvídalo.",
    felikaCopy: "Una app open source de transferencia de archivos centrada en privacidad, emparejamiento explícito, sesiones efímeras y entrega P2P cifrada directa.",
    felikaTags: "P2P · Privacidad · Multiplataforma · Open source",
    arelisTitle: "Los mensajes<br />encuentran el camino.",
    arelisCopy: "Una mensajería distribuida y centrada en privacidad que mueve mensajes por enlaces directos, peers locales y rutas oportunistas store-and-forward.",
    arelisTags: "Mensajería · Mesh · DTN · Open source",
